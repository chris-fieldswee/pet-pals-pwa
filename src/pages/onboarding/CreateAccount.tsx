...
/**
 * Create Account - Complete account creation with first name, password, and email opt-in
 * User has already verified their email with OTP code and is logged in
 */
const CreateAccount = () => {
  ...
  const handleCreateAccount = async () => {
    ...
    try {
      ...
      // Manually create or update the profile
    ...
    <div className="flex flex-col min-h-screen bg-slate-50">
      ...
      <div className="flex-1 px-6 pt-4 overflow-y-auto">
        ...
        <p className="text-base text-slate-600 mb-6">
          We've verified your email. Just a few more details to get started.
        </p>
